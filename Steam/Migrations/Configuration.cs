namespace Steam.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Steam.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Steam.Models.ApplicationDbContext context)
        {
            ...
            // public ApplicationUser(string id, string nickname, string avatar, string info, int level, string email, string password )
            
            
            List<ApplicationUser> applicationUsers = new List<ApplicationUser>();

            applicationUsers.Add(new ApplicationUser("1","potato", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGdd2oZQI_rHaiSwHZeTB4rFuNwSZ4ITAKy-HwWa4KFMfktMLHjw", "Apparently, this user prefers to keep an air of mystery about them.",1,"vladimir@hotmail.com",false,false,false,false,0,"P@ssword1","vlad"));
            applicationUsers.Add(new ApplicationUser("2", "spongieg", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJA8ywdUqycRzLJDVRWZQ81KwEhJPNvRqHr4BiCu1L9yPg1pbsVw", "Apparently, this user prefers to keep an air of mystery about them.", 1, "boromir@hotmail.com", false,false,false,false,0,"P@ssword2","boro"));
            applicationUsers.Add(new ApplicationUser("3", "suffer", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFvl9fL_yUceqiJEinwuV5mdtK6QX6I6q6CRhwD_i8gDbbrjIsgg", "Apparently, this user prefers to keep an air of mystery about them.", 1, "riste@hotmail.com", false,false,false,false,0,"P@ssword3","risto"));

            applicationUsers.ForEach(i => context.Users.AddOrUpdate(i));
            ...
            Dota2Reviews.Add(new Review("1",1, "DONT PLAY RANKED AT 4K .. IF U HAVE BRAIN.. DONTTTT", 3.5f));
            Dota2Reviews.Add(new Review("2", 1, "Very beautiful game my friend", 4.6f));
            Dota2Reviews.Add(new Review("3", 1, "If you want to have girlfriend, dont play this shit", 3.3f));
            Dota2Reviews.ForEach(i => context.Reviews.AddOrUpdate(i));

            SlenderReviews.Add(new Review("2", 6, "Very scary game, which abounds with jump-scares. Also the lighting is on point, catching the atmosphere as should be. I recommend this game 9/10. Btw i am gay.", 4.9f));
            SlenderReviews.ForEach(i => context.Reviews.AddOrUpdate(i));
            

            Magicka2Reviews.Add(new Review("2", 5, "This is my first Steam recommendation for what i consider a hidden gem. I know I am probabbly late to the party, but this is trully great for a quick co-op session. Especially if you're into experimenting with spells a bit and don't mind a steeper learning curve than of a simple hack'n'slash or twin stick shooter.", 4.5f));
            Magicka2Reviews.ForEach(i => context.Reviews.AddOrUpdate(i));
            

   
            List<Comment> comments = new List<Comment>();

            comments.Add(new Comment("1", "2", "Very good dota 2 player, he is absolutely smashing the game. Keep it up bro. Get that TI10."));
            comments.Add(new Comment("1", "3", "I had opportunity to play with him, and learn something of his pocket-tricks."));
            comments.Add(new Comment("2", "1", "Very good support player, if your courier gets killed, this is the guy that will deliver your items."));
            comments.Add(new Comment("3", "2", "Fair trader, honest teammate."));

            comments.ForEach(i => context.Comments.AddOrUpdate(i));
            */
            context.SaveChanges();
